...
declare
  v_allowed constant text[] := array[
    'register','capabilities','list','get','run','open','generate','edit',
...
revoke all on function public.submit_shortcut_job(text,jsonb,integer)
  from public, anon, authenticated;
grant execute on function public.submit_shortcut_job(text,jsonb,integer)
  to service_role;
